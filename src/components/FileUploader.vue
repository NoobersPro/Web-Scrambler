<template>
  <div class="file-uploader">
    <div class="upload-area">
      <label for="file-input" class="file-label">
        <div class="drop-area" @drop.prevent="onDrop" @dragover.prevent>
          ...
          <div class="text">
            ...
            <span class="select-files" v-if="uploadedFiles.length === 0" @click="selectFiles">Select files</span>
          </div>
      ...
      <input type="file" id="file-input" ref="fileInput" @change="onFilesSelected" multiple style="display: none;" />
    </div>
    <div class="options-area">
      ...
      <div v-if="useCustomKey" class="key-options">
        <input type="text" placeholder="Initialization Vector (16 hexadecimal bytes)">
